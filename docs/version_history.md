...
| 커밋 | 이슈 | 날짜 | 내용 |
|------|------|------|------|
| `98785ec` | AN-105 | 2026-03-19 | **RtspServer 파이프라인 개선 및 리소스 관리 수정** |
| `bfc8d3a` | AN-104 | 2026-03-18 | **패킷 IP 주입 및 SUNAPI 프로필 유연화** |
| `7b4db5f` | AN-103 | 2026-03-13 | **InternalClient Poll→Push 전환 + 데드락 수정 + SUNAPI 1회 차단** |
| `c80c69d` | AN-102 | 2026-03-12 | **스레드 누수 해결 및 방어적 코드 개선** |
